...
import { LayoutDashboard, ArrowLeftRight, Wallet, BarChart3, Plus } from 'lucide-react-native';
...
export function TabBar({ state, navigation }: BottomTabBarProps) {
  ...
  return (
    <View
      style={[styles.container, { paddingBottom: bottomPad, height: TAB_BAR_HEIGHT + bottomPad }]}
    >

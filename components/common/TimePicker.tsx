    ...
    <>
      <TouchableOpacity style={styles.trigger} onPress={handlePress} activeOpacity={0.7}>
        ...
        <View style={styles.textContainer}>
          ...
          <Text style={styles.value}>{format(value, 'hh:mm a')}</Text>
        </View>
      </TouchableOpacity>

      {Platform.OS === 'ios' ? (
        <BottomSheet visible={showSheet} onClose={() => setShowSheet(false)} title="Select Time">
          <View style={styles.pickerWrapper}>
            <DateTimePicker
              ...
              style={{ flex: 1 }}
            />
            <TouchableOpacity style={styles.doneBtn} onPress={() => setShowSheet(false)}>

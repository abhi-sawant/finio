    ...
    <View style={styles.container}>
      ...
      <View style={styles.iconColorRow}>
        <TouchableOpacity
          ...
          style={[
            styles.iconPreview,
            { backgroundColor: selectedColor + '33', borderColor: selectedColor },
          ]}
        >
          ...
          render={({ field }) => (
            <View style={styles.chipRow}>
              {ACCOUNT_TYPES.map((t) => (
                ...
                >
                  <Text
                    style={[styles.chipText, field.value === t.value && { color: selectedColor }]}
                  >
                    {t.label}
                  </Text>
                </TouchableOpacity>
      ...
      <View style={styles.field}>
        <Text style={styles.label}>{isCredit ? 'Current Outstanding' : 'Opening Balance'}</Text>
        {isCredit && (
        ...
        <Controller
          ...
          render={({ field }) => (
            <View style={styles.amountWrapper}>
              <AmountInput value={field.value} onChange={field.onChange} currency={currency} />
            </View>
          )}
        />
      </View>
